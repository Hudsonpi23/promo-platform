...
const PRODUCT_TYPE_DETECTORS: Array<{
  ...
  { kw: ['pokémon tcg', 'pokemon tcg', 'carta pokémon', 'carta pokemon', 'booster pokémon', 'booster pokemon', 'pacote booster', 'estampas ilustradas', 'cards pokémon', 'cards pokemon', 'deck pokémon', 'deck pokemon'], phraseKey: 'pokemon tcg' },
  ...
  { kw: ['cabo lightning', 'cabo iphone lightning', 'cabo para iphone', 'lightning usb-c', 'usb-c lightning', 'cabo apple lightning', 'lightning certificado', 'cabo iphone'], phraseKey: 'cabo lightning' },
