...
function getProductSpecificPhrase(title: string): string | null {
  ...
  // Eletrônicos adicionais
  'tablet', 'smartwatch', 'câmera', 'camera', 'caixa de som', 'caixinha', 'mouse', 'teclado', 'webcam', 'power bank', 'carregador portátil',
  // Moda adicional
  'vestido', 'jaqueta', 'moletom', 'bermuda', 'sandália', 'sandalia', 'chinelo', 'bota', 'sapato', 'bolsa', 'óculos', 'oculos',
  // Casa adicional
  'liquidificador', 'cafeteira', 'aspirador', 'ventilador', 'ferro de passar', 'panela', 'conjunto de panelas', 'jogo de cama', 'lençol',
  // Beleza adicional
  'secador', 'chapinha', 'prancha', 'protetor solar', 'shampoo', 'condicionador',
  // Saúde / Mercado
  'whey', 'suplemento', 'vitamina', 'termômetro', 'termometro', 'medidor de pressão',
  // Esportes adicional
  'bicicleta', 'esteira', 'halter', 'anilha',
  // Livros / Papelaria
  'livro', 'mangá', 'manga', 'caderno', 'caneta',
  // Brinquedos
  'boneca', 'carrinho de brinquedo', 'lego', 'blocos de montar', 'nerf',
  // Pets
  'ração', 'racao', 'petisco', 'coleira', 'cama pet',
  // Bebê
  'carrinho de bebê', 'carrinho bebe', 'fralda',
  // Ferramentas / Automotivo
  'furadeira', 'parafusadeira', 'kit ferramentas', 'kit de ferramentas', 'suporte celular', 'câmera ré', 'camera re',
  // Viagem
  'mala', 'mochila de viagem',
  // Games adicional
