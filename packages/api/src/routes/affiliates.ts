...
export async function affiliatesRoutes(app: FastifyInstance) {
  ...
  app.get('/ml-browse/niches', async (_request: FastifyRequest, reply: FastifyReply) => {
    return reply.send({
      ...
      data: {
        niches: [
          { key: 'eletronicos', label: 'Eletrônicos (TV, Som, Smart Home)', categoryId: 'MLB1000' },
          { key: 'celulares', label: 'Celulares e Acessórios', categoryId: 'MLB1051' },
          { key: 'informatica', label: 'Informática (Notebook, PC, Periféricos)', categoryId: 'MLB1648' },
          { key: 'games', label: 'Games (Consoles, Jogos, Acessórios)', categoryId: 'MLB1144' },
          { key: 'eletrodomesticos', label: 'Eletrodomésticos (Air Fryer, Aspirador)', categoryId: 'MLB1581' },
          { key: 'cozinha', label: 'Cozinha (Panelas, Utensílios)', categoryId: 'MLB302726' },
          { key: 'esportes', label: 'Esporte e Fitness (Suplementos, Equip.)', categoryId: 'MLB1276' },
          { key: 'moda', label: 'Moda (Tênis, Roupas, Acessórios)', categoryId: 'MLB1430' },
          { key: 'beleza', label: 'Beleza e Skincare (Masc/Fem)', categoryId: 'MLB1246' },
          { key: 'livros', label: 'Livros, Mangás e HQs', categoryId: 'MLB1168' },
          { key: 'pet', label: 'Pet Shop (Cães e Gatos)', categoryId: 'MLB1071' },
          { key: 'ferramentas', label: 'Ferramentas e Construção', categoryId: 'MLB1500' },
          { key: 'relogios', label: 'Relógios e Smartwatches', categoryId: 'MLB3937' },
          { key: 'alimentos', label: 'Alimentos e Bebidas', categoryId: 'MLB1367' },
          { key: 'veiculos-acessorios', label: 'Acessórios para Veículos', categoryId: 'MLB1743' },
          { key: 'casa', label: 'Casa e Decoração', categoryId: 'MLB1574' },
        ],
