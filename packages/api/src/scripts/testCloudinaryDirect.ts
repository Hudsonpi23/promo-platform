...
const imageUrl = 'https://res.cloudinary.com/dmdiipxhb/image/upload/v1769279332/promo-platform/posts/nzp5faymmr0ye93fo5om.jpg';

async function test() {
  console.log('\n=== TESTE CLOUDINARY DIRETO ===\n');
  ...
  console.log('   Upload completo:', JSON.stringify(uploadResponse.data, null, 2));
  ...
  const tweetBody = {
    text: 'Teste Cloudinary direto ' + Date.now(),
