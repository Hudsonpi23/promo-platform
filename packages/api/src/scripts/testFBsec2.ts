...
const PAGE_1_ID = '991155614081231';
const PAGE_2_ID = '886685174538475';
...
async function run() {
  ...
  await postToFacebook(PAGE_1_ID, PAGE_1_TOKEN, 'Manu das Promocoes');
  await postToFacebook(PAGE_2_ID, PAGE_2_TOKEN, 'Manu Promocoes Tech');
}
